    ...
    <div class="container">
        ...
        <div class="card border-dark">
                ...
                <form id="filterForm">
                    <div class="row">
                        ...
                        <div class="col-2">
                            ...
                            <dd><input class="form-control" type="time" id="endTime" name="endTime"
                                       value="${param.endTime}">
                            </dd>
                        </div>
                    </div>
            ...
            <div class="card-footer text-right">
                <button type="button" class="btn btn-secondary" onclick="resetFilter()"><spring:message code="common.cancel"/></button>
                <button type="button" class="btn btn-primary" onclick="filter()"><spring:message
